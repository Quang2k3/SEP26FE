      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="max-w-2xl">
          ...
          <div className="mb-10 flex items-end gap-6">
            <div className="relative w-[120px] h-[120px] border-2 border-[#333] rounded-full flex items-center justify-center bg-white">
              {/* X placeholder */}
            ...
            <div className="flex flex-col gap-2">
              <button className="sketch-button text-sm">Upload Photo</button>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="flex flex-col gap-2">
                ...
                <input
                  className="sketch-input text-lg bg-gray-100"
                  type="text"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="sketch-box p-2 text-lg bg-gray-100">
                  {formData.department}
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t-2 border-[#333]">
              <button
                className="sketch-button text-2xl font-bold hover:bg-black hover:text-white transition-colors"
                type="submit"
              >
